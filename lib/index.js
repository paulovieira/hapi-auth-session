...
*/
    ...
    var cookieSchemeOptions = Hoek.clone(options.strategy.scheme);
    cookieSchemeOptions.validateFunc = function(request, session, callback) {
        debugger;

        // note: session[options.cookieName] is the uuid previously used in sessionCache.set
        var key = cookieSchemeOptions.cookie;
...
*/
    ...
    server.auth.strategy(options.strategy.name, "cookie", options.strategy.mode, cookieSchemeOptions);
                ...
                options.validateLoginData(request, function(err, loginData){
                    ...
                    sessionCache.set(
                        ...
                        function(err) {
                            ...
                            var cookieCrumb = {};
                            cookieCrumb[cookieSchemeOptions.cookie] = newSession.uuid;
...
debugger;
                ...
                if(request.auth.artifacts){
                    ...
                    uuid = request.auth.artifacts[cookieSchemeOptions.cookie];
                }
